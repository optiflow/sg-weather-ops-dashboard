...
export function CloudIcon({ className = 'h-5 w-5', ...props }: IconProps) {
  return (
...
export function LocationIcon({ className = 'h-3 w-3', ...props }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} {...base} {...props}>
...
export function WindIcon({ className = 'h-3.5 w-3.5', ...props }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} {...base} {...props}>
...
export function DropletIcon({ className = 'h-3.5 w-3.5', ...props }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} {...base} {...props}>
...
export function EyeIcon({ className = 'h-3.5 w-3.5', ...props }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} {...base} {...props}>
...
export function GaugeIcon({ className = 'h-3.5 w-3.5', ...props }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} {...base} {...props}>
...
export function ThermometerIcon({ className = 'h-3.5 w-3.5', ...props }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} {...base} {...props}>
...
export function TrendIcon({ className = 'h-3.5 w-3.5', ...props }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} {...base} {...props}>
